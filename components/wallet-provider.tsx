...
createAppKit({
  ...
  metadata: {
    name: 'Quizmania',
    description: 'Quizmania - Play quizzes and earn rewards',
    url: 'https://quizmania.vercel.app/',
    icons: ['https://quizmania.vercel.app/images/icon.png']
  },
  features: {
    analytics: true, // Disable analytics to prevent extra renders
