...
export function WalletActions() {
  ...
  }, [mounted, isConnected, address, isConnecting, status])
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        type="button"
        className="bg-white text-black w-full rounded-lg p-2 text-sm font-medium active:scale-95 transition disabled:opacity-50"
        onClick={() => open()}
